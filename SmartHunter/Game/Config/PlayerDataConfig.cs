...
namespace SmartHunter.Game.Config
{
    public class PlayerDataConfig
    {
        ...
        public StatusEffectConfig[] StatusEffects =
        {
            ...
            new StatusEffectConfig("Horn", "LOC_STATUS_EFFECT_ELEMENTAL_RESISTANCE_UP", MemorySource.Base, indexToHexStrNoOffset(59)),
            ...
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_ATTACK_UP_S", MemorySource.Base, indexToHexStrNoOffset(65)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_ATTACK_UP_L", MemorySource.Base, indexToHexStrNoOffset(66)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_DEFENSE_UP_S", MemorySource.Base, indexToHexStrNoOffset(67)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_DEFENSE_UP_L", MemorySource.Base, indexToHexStrNoOffset(68)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_AFFINITY_UP", MemorySource.Base, indexToHexStrNoOffset(69)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_HEALTH_RECOVERY", MemorySource.Base, indexToHexStrNoOffset(70)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_HEALTH_BOOST", MemorySource.Base, indexToHexStrNoOffset(71)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_STAMINA_USE_REDUCED", MemorySource.Base, indexToHexStrNoOffset(72)),

            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_DIVINE_PROTECTION", MemorySource.Base, indexToHexStrNoOffset(74)),

            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_STUN_NEGATED", MemorySource.Base, indexToHexStrNoOffset(76)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_PARALYSIS_NEGATED", MemorySource.Base, indexToHexStrNoOffset(77)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_TREMORS_NEGATED", MemorySource.Base, indexToHexStrNoOffset(78)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_EARPLUGS_S", MemorySource.Base, indexToHexStrNoOffset(79)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_WIND_PRESSURE_NEGATED", MemorySource.Base, indexToHexStrNoOffset(80)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_ENVIRONMENTAL_DAMAGE_NEGATED", MemorySource.Base, indexToHexStrNoOffset(81)),
